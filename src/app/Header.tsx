      ...
      <div className="flex items-center gap-2 sm:gap-4">
        {isAuthenticated && (
          <div className="relative hidden sm:block">
            <input type="text" placeholder="Buscar posts..." className="rounded-md border border-gray-200 dark:border-neutral-700 px-3 py-2 text-sm w-32 sm:w-48 focus:outline-none focus:ring-2 focus:ring-black/10 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-neutral-900" />
        ...
        {isAuthenticated && (
          <button 
            onClick={handleCriarPublicacaoClick}
